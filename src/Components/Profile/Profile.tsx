  ...
  const handleUploadPhoto = async () => {
    try {
      ...
      if (selectedFile) {
        ...
        const response = await axios.post(import.meta.env.VITE_BACKEND_URL+'profilePhoto', formData, {
          headers: {
      ...
      <div className="profile-info">
        <img className="profile-photo" src={profilePhotoURL} alt="Profile" />
          ...
          <div className="profile-details">
            ...
            <button className='btn btn-dark' onClick={handleUploadPhoto}>Upload Photo</button>
          </div>
